...
proves file-only DRC still reports its UUID, and proves both synchronized tools
remove it after refill/save. Set `KONNECT_LIVE_KICAD_BOARD`, `KICAD_API_SOCKET`,
